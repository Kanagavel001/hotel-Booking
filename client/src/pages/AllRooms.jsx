    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div>
          ...
          <div className='flex flex-col items-start text-left'>
            ...
            <p className='text-sm md:text-base text-gray-500/90 mt-2'>TakeTake advantage of our limited-time offers and special packages to enhance your stay and create unforgettable memories.</p>
          </div>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16' >
          ...
          <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border-b border-gray-300 ${openFilters && 'border-b'}`}>
            ...
            <div className='text-xs cursor-pointer' >
              <span onClick={clearFilters} className={` ${openFilters ? "" : 'hidden'} text-black lg:block`}>CLEAR</span>
              <span onClick={()=>setOpenFilters(!openFilters)} className=' lg:hidden ml-2'>
